...
#     np.savetxt("../gt_instance/trees_/" + str(id) + ".txt", trees_component[id])
...
prefix = "../gt_instance/trees_/"
pcd = o3d.io.read_point_cloud(prefix + "148.txt", format="xyz")
print("------------------------ pcd attribute ------------------------")
print(
    "has_colors:",
    pcd.has_colors(),
...
coords = points[:, 0:2]
values = points[:, 2]
tree = KDTree(coords, leaf_size=1000)
radius = 4
seperate_radius = 1
